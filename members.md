...
<div style="display: flex; align-items: top; margin-bottom: 40px;">
    ...
    <div style="flex: 70%;">
        ...
        <p style="font-size: 16px;">Dr. Fabricio Cravo is a Postdoctoral Researcher in the NeuroPRISM Lab specializing in computational and statistical analysis of fMRI data, particularly for more powerful study planning and inference. Dr. Cravo received his Master's degree in Computer Engineering from CentraleSupélec, France, with a specialization in AI, machine learning, and databases. He then completed his Ph.D. in Computer Science and Applied Mathematics at Paris-Saclay University (#1 global math ARWU, 2020-2023), where his research focused on distributed algorithms for microbiological systems and mathematical modeling of gene regulatory networks with both Continuous-Time Markov and Ordinary Differential Equation models. He is currently the lead developer of MobsPy, a programming language for biochemical reaction networks, and SHOCK, an empirical power calculator for fMRI studies for empirical statistical power analysis.
